            ...
            <nav className="max-w-full w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center">
                        <div className="sm:hidden">
                            <Sheet>
                                ...
                                <SheetContent side={"left"} className="w-[300px] sm:w-[340px]">
                                    <SheetHeader>
                                        <SheetTitle className='text-left text-xl font-bold ml-3'>TQ5 - Phần bài tập</SheetTitle>
                                        <SheetDescription>
                                            <SidebarMenu />
                                        </SheetDescription>
                                    </SheetHeader>
                        ...
                        <a className="flex-none text-xl ml-4 font-semibold text-white" href="/"> ⬅️ TQ5 - Phần bài tập</a>
                    </div>
                    <div className="flex items-center">
                        <DarkModeSwitch
